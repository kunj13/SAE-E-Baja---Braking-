...
mass_driver = 70;
max_speed_kmph = 40;
max_speed_mps = 40*5/17;
mu_tyretoroad = 0.7;               % + static cofficient 
mu_tyretoroad_kinetic = 0.6;        % kinetic cofficient
mu_pad=0.4;
h_cog= 0.450;
wheelbase= 1.420;
static_weight_ratio = 35/65;        % Front to Rear
wheel_radius_front=0.2667;
wheel_radius_rear=0.2921;
pedal_ratio = 5;
pedal_leverage = 0.75;
man_pedal_force = 140;
front_disc_dia = 300*0.001;
rear_disc_dia = 350*0.001;
dia_eff_front = (front_disc_dia- 20*0.001);
dia_eff_rear = (rear_disc_dia - 20*0.001);
caliper_piston_dia_front = 0.02844;
caliper_piston_dia_rear = 0.0345;

%master cylinder required values
    tmc_piston_dia = (15.875)*0.001;
...
%thermal considerations
    ...
    %eff_front_dia = torque_front/(2*caliper_force_front);
    weightfront = 270 + weighttransfer;
    toque_front = mu_tyretoroad_kinetic*weight_front;